...
import maruf.com.myapplication.Ranting.Bayar_Client;
import maruf.com.myapplication.Ranting.MenuUtama;
import maruf.com.myapplication.Ranting.Profilname;
...
//        });
    ...
    public void dsghd(View view) {

        Intent abg =new Intent(Mantab.this, Bayar_Client.class);
...
String a=txttampil.getText().toString();
    ...
    public void dhshdh(View view) {
        Intent abg =new Intent(Mantab.this, Profilname.class);
    ...
    public void hks(View view) {
        Intent abg =new Intent(Mantab.this, MenuUtama.class);
